...
unsigned int nStakeMinAge = 12 * 60 * 60; // 12 hours minimum age
unsigned int nStakeMaxAge = 60 * 60 * 24 * 80;	// stake age of full weight: 80d
...
const string strMessageMagic = "Koalacoin Signed Message:\n";
...
static const int CUTOFF_HEIGHT = 7200; // Height at the end of 8 weeks
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    if(nHeight == 1)
    {
        nSubsidy = 0.0055 * 400000000 * COIN;
...
const int YEARLY_BLOCKCOUNT = 2628000;	// 365 * 7200
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Koalacoin
    bool fStrictPayToScriptHash = true; // Always active in Koalacoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Koalacoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Koala's roam the landscape. Koalacoin 58129 2914 124045 9555";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1394129192;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1887222;
    if (false  && (block.GetHash() != hashGenesisBlock)) {
        ...
        assert(block.hashMerkleRoot == uint256("7341d921603303a2de04df5103298ab6656a69e5b1218713e4ecd1944b4ce8d6"));
